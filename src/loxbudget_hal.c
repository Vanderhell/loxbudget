...
loxbudget_bool_t LOXBUDGET_WEAK loxbudget_hal_boot_proven(void) {
  return LOXBUDGET_FALSE;
}
loxbudget_bool_t LOXBUDGET_WEAK loxbudget_hal_voltage_ok(void) {
  return LOXBUDGET_FALSE;
}
loxbudget_bool_t LOXBUDGET_WEAK loxbudget_hal_network_up(void) {
  return LOXBUDGET_FALSE;
}
...
const loxbudget_hal_callbacks_t *loxbudget_hal_default_permissive(void) {
  static const loxbudget_hal_callbacks_t cb = {
      &loxbudget_hal_perm_now_ms_, &loxbudget_hal_perm_crit_enter_,
      &loxbudget_hal_perm_crit_exit_, &loxbudget_hal_perm_true_,
      &loxbudget_hal_perm_true_, &loxbudget_hal_perm_true_};
  return &cb;
}
